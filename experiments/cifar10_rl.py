...
def main():
    ...
    print("=" * 60)
    print("RL Controller Search on CIFAR-10")
    print("=" * 60)
    ...
    # Trajectory plot
    trajectory_plot = plot_dir / 'cifar10_rl_trajectory.png'
    viz.plot_search_trajectory(str(results_file), str(trajectory_plot))

    # RL metrics plot
    rl_metrics_plot = plot_dir / 'cifar10_rl_metrics.png'
    ...
    print("\n✓ RL search on CIFAR-10 completed!")
